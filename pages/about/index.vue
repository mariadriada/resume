    ...
    <div id="data-container">
      ...
      <div id="box-container" class="box-container budge-right">
        <div class="side left-side">
          <info-container :img="`${ img.src }`" :alt="`${ img.alt }`"></info-container>
        </div>

        <div class="side center-side">
          <info-container activeList="true" idData="1" cls="bkg"></info-container>
        </div>
      ...
      <div class="next-container">
        ...
        <div class="block">
          <div class="side middle middle1">
            <info-container activeList="true" idData="2" class="data2"></info-container>
          </div>

          <div class="side middle description">
            <opacity-container :text="`${profession.text1}`" class="blue"></opacity-container>
          </div>
        </div>

        <div class="block b1">
          <opacity-container :text="`${profession.text2}`" class="default center"></opacity-container>
        </div>
      </div>
      <!-- next-container -->
      <footer-div/>
...
export default {
  ...
  methods: {
    ...
    resize() {
      ...
      document.getElementById('data-container').style.top = `${
        this.headerHeight
      }px`
    },
    menuShowHide() {
...
@media screen and (max-width: 30rem) {
  #main-container {
    #box-container {
      @include flex-direction(column) background-image: url('/img/tsmall.png');
      background-size: 50%;
