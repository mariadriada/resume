<template>
  <div id="skills-main-container">
    ...
    <div v-on:click.prevent="up" class="button button-up visible" id="button-up">
      ...
      <div id="dynamic-text">
        ...
        <!-- Technologies -->
        <skills idData="1" class="panel" ></skills>
        <!-- /Technologies -->

        <!-- Databases -->
        <skills idData="2" class="panel" ></skills>
        <!-- /Databases -->
...
export default {
  ...
  data () {
    return {
      ...
      text2: 'My current English level is medium, I am working on improving my pronunciation skills.',
      html: '',
      subject: [],
      observerScroll: [],
      observerResize: [],
