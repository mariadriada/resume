<template>
  <ul id="experience-list">
    <item
      v-for="{ id, company, rol, date, observation } in list "
      :key="id"
      :company="company"
      :rol="rol"
      :date="date"
...
<script>
import Item from '~/components/ExperienceItem.vue'
    ...
    return {
      list: [
        ...
        },
        {
          ...
          observation:
            'Providing technical service and support to informatica rooms.'
        }
      ]
    }
  }
